...
def save_single(operator, scene, depsgraph, filepath="",
    ...
    settings = FBXExportSettings(
        ...
        False, media_settings, use_custom_props, shape_keys_baked_data_dict,#Auto-Rig Pro implant
    )
